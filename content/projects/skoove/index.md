---
title: "From Help Center article to decision-making experience"
layout: "skoove"
url: "/skoove"
summary: Skoove · Freelance Product Design
weight: 1
ShowToc: true
TocOpen: true
ShowPostNavLinks: true
cover:
  image: images/skoove-thumb.png
  alt: "Skoove"
  caption: "Skoove"
  relative: true
  hidden: true
...
<p class="intro-description">Working closely with marketing stakeholders, I helped transform pricing information into a dedicated decision-making experience for future learners, balancing discoverability, content strategy and conversion goals.</p>
  ...
  <div class="intro-details-wrapper">
      ...
      <p class="intro-details no-margin-bottom"><span class="fi" style="background-image: url(/images/globe.svg)"></span> Freelance Project</p>
      <p class="intro-details no-margin-bottom"><span class="fi" style="background-image: url(/images/calendar.svg)"></span> 2026</p>
  </div>
</div>

![Skoove pricing page — hero section](images/skoove-intro.png)
...
<a href="images/skoove-context.png" class="lightbox">
  <img src="images/skoove-context.png" alt="Side-by-side comparison of the logged-in pricing page and the Help Center article for logged-out users">
</a>

<p class="photo-footnote">Side-by-side comparison of the existing pricing page available to logged-in users without a premium subscription and the Help Center pricing article (logged-out experience).</p>

---

<h3>Pricing existed,</br>but the pricing experience didn't</h3>
...
<a href="images/skoove-flow-before.png" class="lightbox">
  <img src="images/skoove-flow-before.png" alt="User flow showing how non-premium users navigated from landing page to subscription purchase">
</a>

<p class="photo-footnote">Current user flow showing how non-premium users navigated from landing page to subscription purchase.</p>
...
<a href="images/skoove-early-explorations.png" class="lightbox">
  <img src="images/skoove-early-explorations.png" alt="Early layout explorations and annotated design iterations for the Skoove pricing page">
</a>

<p class="photo-footnote">Early layout explorations, marketing proposals and annotated design iterations showing how the page structure evolved.</p>

<a href="images/skoove-final.png" class="lightbox">
  <img src="images/skoove-final.png" alt="Final Skoove pricing page design showing plan comparison, benefits, FAQs and conversion sections">
</a>

<p class="photo-footnote">Final pricing page design highlighting plan comparison, benefits, FAQs and conversion-focused sections.</p>
...
<a href="images/skoove-web-ui-kit.png" class="lightbox">
  <img src="images/skoove-web-ui-kit.png" alt="New components created for the Skoove pricing project and integrated into the Web UI Kit">
</a>

<p class="photo-footnote">New components created for the project and later integrated into the Web UI Kit.</p>
...
<a href="images/skoove-navigation.png" class="lightbox">
